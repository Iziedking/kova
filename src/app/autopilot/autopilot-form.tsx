...
export default function AutopilotForm() {
  return <section className="mandate-card" aria-labelledby="autopilot-fallback-title">
    ...
    <p className="disclosure">FLOAT does not accept delegated signing or automatic rebalancing in this build. Review a supported market to inspect the user-owned boundary.</p>
