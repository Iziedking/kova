...
export default function NewCampaignPage() {
  return <main className="autopilot-page kova-legacy">
    ...
    <section className="autopilot-intro" aria-labelledby="campaign-title">
      ...
      <p>The preview catalog can show how projects compete for liquidity, but KOVA does not accept creator submissions or treat an ANSEM commitment as funded without verified authority and balance evidence.</p>
    </section>
