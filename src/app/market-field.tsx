...
export function MarketField({ stockSymbol = "NVDAx", memeSymbol = "NVDGE" }: MarketFieldProps) {
  return <div className="market-field" aria-label="Illustrative market activity field">
    ...
    <svg className="field-chart" viewBox="0 0 720 310" role="img" aria-label="Illustrative liquidity and activity chart">
      <defs>
        <linearGradient id="field-fill" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#D9772B" stopOpacity=".2" /><stop offset="1" stopColor="#D9772B" stopOpacity="0" /></linearGradient>
      ...
      <path className="field-line field-line-main" d="M0 252C68 228 80 246 139 210s67-17 111-42 62 31 100-10 68-54 112-31 55-2 83-38 85-44 175-73" fill="none" stroke="#D9772B" strokeWidth="3" />
      <path className="field-line field-line-ghost" d="M0 270C69 255 96 270 142 245s77 8 113-13 64 25 103-1 55-41 101-22 64 4 93-21 81-34 168-44" fill="none" stroke="#F28C28" strokeOpacity=".42" strokeWidth="1.5" strokeDasharray="6 8" />
      <g className="field-candles" fill="none" stroke="#F28C28" strokeWidth="2">
      ...
      <circle className="field-dot" cx="558" cy="78" r="5" fill="#F28C28" />
    </svg>
