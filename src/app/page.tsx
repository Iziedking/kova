...
import { KovaLogo } from "./float-logo";
...
function DepthCrossSection({ market }: { market: DiscoverMarket }) {
  return <div className="depth-object" aria-label="Illustrative liquidity depth cross-section">
    <div className="depth-object-header"><span>KOVA / DEPTH CROSS-SECTION</span><span className="object-note">ILLUSTRATIVE · CAPTURED {market.snapshotAt.slice(0, 10)}</span></div>
